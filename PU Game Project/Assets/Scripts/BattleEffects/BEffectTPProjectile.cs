...
{
    public class BEffectTPProjectile : BEffectTP
    {
        ...
        public BEffectTPProjectile(GameEntity _source, SelectorPacket _givenPacket, GameObject _fireObjectRef) : base(_source, _givenPacket)
        {
            this.fireObjectRef = _fireObjectRef;
        }
        public BEffectTPProjectile(GameEntity _source, AbilityDataPacket _effectData, SelectorPacket _givenPacket, GameObject _fireObjectRef) : base(_source, _effectData, _givenPacket)
        {
            this.fireObjectRef = _fireObjectRef;
        }
        ...
        private void ProjectileLogic()
        {
            ...
            {
                new BAnimMoveToPos(this, hitInfo.point, currentMovingObj, (baseMoveSpeed + (moveSpeedAccel * subRIndex)), true);
            ...
            else
            {
                ...
                {
                    new BAnimMoveToPos(this, currentProj.path[subRIndex + 1], currentMovingObj, (baseMoveSpeed + (moveSpeedAccel * subRIndex)), true);
                    Debug.Log("Projectile MOVE[END] Anim Event");
                }
                else
                {
                    new BAnimMoveToPos(this, currentProj.path[subRIndex + 1], currentMovingObj, (baseMoveSpeed + (moveSpeedAccel * subRIndex)), false);
