...
public class CharAbility : ScriptableObject
{
    ...
    */
    ...
    public List<Action<AbilityDataPacket>> castableAbilities = new List<Action<AbilityDataPacket>>();
    ...
    private void CastAbility(int abilityIndex, List<SelectorPacket> givenTargets)
    {
        ...
        AbilityDataPacket effectPacket = new AbilityDataPacket();
    ...
    protected virtual void PayEnergyCost(AbilityDataPacket givenPacket)
    {
    ...
    protected virtual void SetCooldown(AbilityDataPacket givenPacket)
    {
