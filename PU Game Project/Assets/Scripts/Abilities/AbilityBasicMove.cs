...
public class AbilityBasicMove : CharAbility {
    ...
    private void Run(AbilityDataPacket effectDataPacket)
    {
        ...
        BEffectGridMove moveEffect = new BEffectGridMove(associatedEntity, effectDataPacket, movingTarget.gameObject, path);
    ...
    */
    ...
    protected override void PayEnergyCost(AbilityDataPacket givenPacket)
    {
